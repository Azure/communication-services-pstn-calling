      ...
      <div className="header ms-Grid">
        <div className="ms-Grid-row">
          <div className="ms-Grid-col ms-lg6">
            <h2>Azure Communication Services - Calling SDK for Javascript - {callingSdkVersion}</h2>
          </div>
          <div className="ms-Grid-col ms-lg6">
            ...
            <div className="sdk-docs-header">
              <a
                className="sdk-docs-link"
                href="https://docs.microsoft.com/en-us/javascript/api/azure-communication-services/@azure/communication-calling/?view=azure-communication-services-js"
              >
