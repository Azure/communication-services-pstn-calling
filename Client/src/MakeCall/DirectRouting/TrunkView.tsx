...
const validateTrunks = (trunks: Trunk[]): Trunk[] => {
    ...
    const fqdnCount = trunks.reduce((acc, {fqdn}) => ({
        ...acc, 
        ...
        <div className="ms-Grid-row f-1 pr-3"> 
            <div className="ms-Grid-col ms-sm8">
                <TextField
                    ...
                    value={trunk.fqdn} 
                    onChange={event => onChange != null && onChange('fqdn', trunk, (event.target as HTMLTextAreaElement).value)} 
            ...
            <div className="ms-Grid-col ms-sm4">
                <NumberTextField
                    ...
                    placeholder='8080'
                    type='number'
                    onChange={event => onChange != null && onChange('sipSignalingPort', trunk, (event.target as HTMLTextAreaElement).value)}
...
const NumberTextField: React.FC<NumberTextFieldProps> = ({ value, onChange: propsOnChange, ...props}) => {
    const [internalValue, setInternalValue] = React.useState(() => value == null || isNaN(value) ? '' : value.toString());
